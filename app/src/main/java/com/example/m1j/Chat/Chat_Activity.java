...
import com.example.m1j.Chat.Audio.Play_Audio_F;
import com.example.m1j.Chat.Audio.SendAudio;
...
import com.example.m1j.See_Full_Image_F;
...
public class Chat_Activity extends Fragment {
    ...
    public void SendMessage(final String message) {
        ...
        rootref.updateChildren(user_map, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                HashMap<String, java.io.Serializable> sendermap = new HashMap<String, java.io.Serializable>();
                ...
                HashMap<String, java.io.Serializable> receivermap = new HashMap<String, java.io.Serializable>();
    ...
    public void UploadImage(ByteArrayOutputStream byteArrayOutputStream) {
        ...
        reference.child("images").child(key + ".jpg").putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                HashMap<String, String> message_user_map = new HashMap<String, String>();
                message_user_map.put("receiver_id", Receiverid);
                message_user_map.put("sender_id", senderid);
    ...
    public void update_message(Chat_GetSet item) {
        ...
        final HashMap<String, String> message_user_map = new HashMap<String, String>();
